...
start(Sleep) ->
  ...
  ProposerNames = [{"Fry", ?RED}, {"Bender", ?GREEN}, {"Leela", ?BLUE},{"Zoidberg", ?PURPLE},{"P.Farnsworth",?CYAN}],
  PropInfo = [{fry, ?RED}, {bender, ?GREEN}, {leela, ?BLUE},{zoidberg, ?PURPLE},{p_farnsworth,?CYAN}],
